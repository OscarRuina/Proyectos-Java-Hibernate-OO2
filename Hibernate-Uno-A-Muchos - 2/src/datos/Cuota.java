...
public class Cuota {
	...
	public String toString() {
		return "Cuota [idCuota=" + idCuota + ", nroCuota=" + nroCuota + ", fechaVencimiento=" + Funciones.traerFechaCorta(fechaVencimiento)
				+ ", saldoPendiente=" + saldoPendiente + ", amortizacion=" + amortizacion + ", interesCuota="
				+ interesCuota + ", cuota=" + cuota + ", deuda=" + deuda + ", cancelacion=" + cancelacion
				+ ", fechaDePago=" + Funciones.traerFechaCorta(fechaDePago) + ", punitorios=" + punitorios + "]";
	}
